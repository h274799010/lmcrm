...
class Payment
{
     ...
     *
     * метод либо добавляет, либо снимает сумму с кошелька указанного агента
     * в зависимости от -\+ задаваемой суммы
     *
     *
     * @param  array  $data
     *
    ...
    public static function single( $data )
    {
        ...
        [
            'initiator_id'  => '',  // id инициатора платежа
            'user_id'       => '',  // id пользователя, на кошелек которого будет зачисленна/снята сумма
            'wallet_type'   => '',  // тип кошелька с которого снимается сумма
            'type'          => '',  // тип транзакции
            'amount'        => '',  // снимаемая/добавляемая сумма (в зависимости от значения -/+ суммы )
            'lead_id'       => '',  // (не обязательно) id лида если он учавствует в платеже
            'lead_number'   => '',  // (не обязательно) количество лидов, если их несколько
        ];
        */
