        ...
        <div class="col-md-12 col-xs-12" id="leadsListFilter">
            <div class="col-xs-2">
                <div class="form-group">
                    ...
                    <select data-name="sphere" class="dataTables_filter form-control connectedFilter notSelectBoxIt" id="spheresFilter" data-placeholder="-">
                        <option value=""></option>
            ...
            <div class="col-xs-2">
                <div class="form-group">
                    ...
                    <select data-name="operator" class="dataTables_filter form-control connectedFilter notSelectBoxIt" id="operatorsFilter" data-placeholder="-">
                        <option value=""></option>
            ...
            <div class="col-xs-2">
                <div class="form-group">
                    ...
                    <select data-name="agent" class="dataTables_filter form-control connectedFilter notSelectBoxIt" id="agentsFilter" data-placeholder="-">
                        <option value=""></option>
            ...
            <div class="col-xs-2">
                <div class="form-group">
                    ...
                    <select data-name="role" class="dataTables_filter form-control notSelectBoxIt" id="rolesFilter" data-placeholder="-">
                        <option value=""></option>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '.connectedFilter', function () {
                ...
                $.post('{{ route('accountManager.lead.getFilter') }}', params, function (data) {
