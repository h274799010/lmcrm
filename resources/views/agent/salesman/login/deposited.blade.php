...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="row">
            ...
            <div class="col-md-12">
                <table class="table table-bordered table-striped table-hover dataTable" id="depositedLeadTable">
                    <thead>
                    <tr>
    ...
    <script type="text/javascript">
        ...
        $(window).on('load', function () {
            ...
            var dTable = $table.DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url" : '{{ route('agent.salesman.depositedLead.data', ['salesman_id' => $salesman_id]) }}',
                    "data": function (d) {
