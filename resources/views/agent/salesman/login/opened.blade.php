...
<div class="row">
    ...
    <div id="main_table" class="col-md-12">
        ...
        <table class="table table-bordered table-striped table-hover openLeadsTable" id="openLeadsTable">
            <thead>
            <tr>
                <th></th>
    ...
    <script>
            ...
            $(document).on('click', '#btnSetStatus', function (e) {
                ...
                if($status.length > 0) {
                    ...
                    if(type == '{{ \App\Models\SphereStatuses::STATUS_TYPE_CLOSED_DEAL }}') {
                        ...
                        $.post('{{  route('agent.salesman.lead.setOpenLeadStatus', ['salesman_id'=>$salesman_id]) }}', params, function( data ){
        ...
        $(window).on('load', function () {
            ...
            var dTable = $table.DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url" : '{{ route('agent.salesman.openedData', ['salesman_id' => $salesman_id]) }}',
                    "data": function (d) {
