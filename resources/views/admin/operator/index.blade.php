...
@section('main')
    <div class="page-header">
        <h3>
            {!! trans("admin/operator.operators") !!}
    ...
    <div class="row">
        <div class="col-md-6 col-xs-12" id="operatorsListFilter">
            ...
            <div class="col-xs-4">
                <div class="form-group">
                    <label class="control-label _col-sm-3">@lang('statistic.account_manager')</label><br>
    ...
    <table id="operatorsList" class="table table-striped table-hover">
        <thead>
        <tr>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '.connectedFilter', function () {
                ...
                $.post('{{ route('admin.operator.getFilterOperator') }}', params, function (data) {
                    $.each(data, function (i, el) {
                        var tmpObj = null;
                        switch (i) {
                            case 'spheres':
            ...
            oTable = $('#operatorsList').DataTable({
