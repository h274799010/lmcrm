        ...
        <div class="col-xs-12">
            <table class="table table-striped table-hover dataTable1" id="agentCreditReportsTable">
                ...
                <tr>
                    ...
                    <td @if(intval($result['profit']['opened']))class="dirty" @endif >
                        {{ number_format($result['profit']['opened'], 2) }}
                    </td>
                    <td class="dirty">{{ number_format($result['profit']['deals']['total'], 2) }}</td>
                    <td class="profit">{{ number_format($result['profit']['deals']['our'], 2) }}</td>
                    <td class="dirty">{{ number_format($result['profit']['auction']['leads'], 2) }}</td>
                    <td class="profit">{{ number_format($result['profit']['auction']['deals'], 2) }}</td>
                    <td class="dirty">{{ number_format($result['profit']['auction']['total'], 2) }}</td>
                    <td class="loss">{{ number_format($result['profit']['operator'], 2) }}</td>
                    <td class="profit">{{ number_format($result['profit']['profit']['leads'], 2) }}</td>
                    <td class="profit">{{ number_format($result['profit']['profit']['deals'], 2) }}</td>
                    <td class="profit">{{ number_format($result['profit']['profit']['total'], 2) }}</td>
                </tr>
                </tfoot>
            </table>
        </div>
            ...
            <div class="pull-right">
                <table class="table table-striped table-hover total-table">
                    ...
                    <tr>
                        ...
                        <td class="loss">{{ $depositedProfit['count'] }}</td>
                    </tr>
                    <tr>
                        <th>Profitability</th>
                        <td class="profit">{{ number_format($depositedProfit['profit'], 2) }}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            <table class="table table-striped table-hover dataTable1" id="agentCreditReportsTable">
                ...
                <tbody>
                @foreach($result['bayed'] as $detail)
                    <tr>
                        <td>{{ $detail['type'] }}</td>
                        <td>{{ $detail['revenue_share']['from_deals'] }}%</td>
                        <td>{{ $detail['revenue_share']['from_leads'] }}%</td>
                ...
                <tr>
                    <td colspan="4" class="total">Total:</td>
                    <td @if(intval($result['profit_bayed']['opened']))class="dirty" @endif >
                        {{ number_format($result['profit_bayed']['opened'], 2) }}
                    </td>
                    <td class="dirty">{{ number_format($result['profit_bayed']['deals']['total'], 2) }}</td>
                    <td class="profit">{{ number_format($result['profit_bayed']['deals']['our'], 2) }}</td>
        ...
        <div class="col-xs-12">
            <div class="pull-right">
                <table class="table table-striped table-hover total-table">
                    ...
                    <tr>
                        <th>Profitability</th>
                        <td class="profit">{{ number_format($bayedProfit['profit'], 2) }}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
